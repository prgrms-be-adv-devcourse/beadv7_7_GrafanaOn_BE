...
import shop.dear.commerce.cart.infrastructure.client.dto.CartHttpErrorCode;
...
public class CartClientConfig {
    ...
    @Bean
    RestClient cartRestClient(@Value("${cart.client.base-url}") final String baseUrl) {
        return RestClient.builder()
                ...
                .defaultStatusHandler(HttpStatusCode::isError, (request, response) -> {
                    ...
                    throw new BusinessException(CartHttpErrorCode.EXTERNAL_API_ERROR);
                })
                .build();
    }
